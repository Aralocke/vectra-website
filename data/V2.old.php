<?php
	...
	$query = "SELECT t1.topic_poster, t1.topic_replies, t1.topic_title, t1.topic_time, t1.forum_id, t1.topic_id, t2.username, t3.post_text, t3.post_id, t3.post_subject FROM phpbb_topics t1, phpbb_users t2, phpbb_posts_text t3 WHERE t1.topic_poster = t2.user_id AND t1.forum_id = $NewsForum AND t1.topic_title = t3.post_subject ORDER BY t1.topic_time DESC";
...
?><?php echo('<?xml version="1.0" encoding="utf-8"?>'); ?>
	<vectra>
	 <?php if ($totalRows > 0) { // Show if recordset not empty ?>
     	<?php do { ?>
        	<news>
            	<link>http://vectra-bot.org/forum/viewtopic.php?t=<?php echo $row['topic_id']; ?></link>
